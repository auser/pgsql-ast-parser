...
describe("Create table", () => {
  ...
  checkCreateTable(
    [
      "create temp table test(value text)",
      "create temporary table test(value text)",
    ],
    {
      type: "create table",
      name: { name: "test" },
  ...
  checkCreateTable(
    [
      "create global table test(value text)",
      "create GLOBAL table test(value text)",
    ],
    {
      type: "create table",
  ...
  checkCreateTable(
    ['create table"test"(a text, constraint pkey primary key(a), b text)'],
    {
      type: "create table",
      name: { name: "test" },
      columns: [
  ...
  checkCreateTable(
    [`create table"test"(a text, constraint cname check (a != 'a'))`],
    {
      type: "create table",
      name: { name: "test" },
      columns: [
